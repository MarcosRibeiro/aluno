...
class CadastroAlunoResourceIT {
    ...
    void getAllCadastroAlunos() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_MEDIA_ESCOLAR.doubleValue()))
            ...
            .value(hasItem(DEFAULT_AUTORIZACAO.booleanValue()))
            .jsonPath("$.[*].fotoAluno")
    ...
    void getCadastroAluno() {
        ...
        webTestClient
            ...
            .jsonPath("$.mediaEscolar")
            .value(is(DEFAULT_MEDIA_ESCOLAR.doubleValue()))
            .jsonPath("$.prioritario")
            ...
            .jsonPath("$.autorizacao")
            .value(is(DEFAULT_AUTORIZACAO.booleanValue()))
            .jsonPath("$.fotoAluno")
