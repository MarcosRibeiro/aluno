...
import { sampleWithRequiredData } from '../responsavel.test-samples';
...
describe('Responsavel Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to responsavelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getResponsavelIdentifier');
      const id = comp.trackId(entity);
      expect(service.getResponsavelIdentifier).toHaveBeenCalledWith(entity);
