...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../responsavel.test-samples';

import { ResponsavelService } from './responsavel.service';

const requireRestSample: IResponsavel = {
...
describe('Responsavel Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Responsavel', () => {
      const responsavel = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(responsavel).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Responsavel', () => {
      const responsavel = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(responsavel).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should handle exceptions for searching a Responsavel', () => {
    ...
    describe('addResponsavelToCollectionIfMissing', () => {
      it('should add a Responsavel to an empty array', () => {
        const responsavel: IResponsavel = sampleWithRequiredData;
      ...
      it("should add a Responsavel to an array that doesn't contain it", () => {
        const responsavel: IResponsavel = sampleWithRequiredData;
        const responsavelCollection: IResponsavel[] = [sampleWithPartialData];
        expectedResult = service.addResponsavelToCollectionIfMissing(responsavelCollection, responsavel);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(responsavel);
      });
      ...
      it('should add only unique Responsavel to an array', () => {
        const responsavelArray: IResponsavel[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const responsavelCollection: IResponsavel[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const responsavel: IResponsavel = sampleWithRequiredData;
        const responsavel2: IResponsavel = sampleWithPartialData;
    ...
    describe('compareResponsavel', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareResponsavel(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareResponsavel(entity1, entity2);
        const compareResult2 = service.compareResponsavel(entity2, entity1);
