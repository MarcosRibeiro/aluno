...
import { sampleWithRequiredData } from '../cadastro-aluno.test-samples';
...
describe('CadastroAluno Management Component', () => {
  let comp: CadastroAlunoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CadastroAlunoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cadastroAlunos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cadastroAlunoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCadastroAlunoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCadastroAlunoIdentifier).toHaveBeenCalledWith(entity);
